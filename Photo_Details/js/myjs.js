...
// Main function to show details
function getPhoto()
{
    const confirmAction = confirm("Are you sure display ....? ");
    if (!confirmAction) {
...
function showDetails() {
    ...
    // Remove previous special frames
    ...
    // User clicked OK → display photo and details
...
//document.getElementById("okBtn").addEventListener("click", showDetails);
